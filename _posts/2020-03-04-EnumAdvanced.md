...
- **프로토콜 선언**
    ...
    <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced1.swift %} </p>
...
- **열거형 프로토콜 채택**
    ...
    <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced2.swift %} </p>

- **사용하기**

    프로토콜을 채택하여 만든 프로퍼티와 메서드 사용하는 방법은 기존에 직접 정의 했을 때 처럼 사용하면 됩니다.

    <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced3.swift %} </p>
...
- **익스텐션 사용하기**
    ...
    <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced4.swift %} </p>
...
- **프로토콜 익스텐션 만들기**
    ...
    <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced5.swift %} </p>
...
- **프로토콜 익스텐션 재정의**
    ...
    <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced6.swift %} </p>
...
- **옵셔널 구현 형태**
    ...
    **\<Wrapped\>**가 제네릭 파라메터이고 이 제네릭 파라메터로 다양한 타입의 옵셔널을 만들 수 있게 되는 것입니다.
    ...
    <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced7.swift %} </p>

- **옵셔널 열거형 사용**

    옵셔널을 구현할 때 단순하게 변수 타입에 ?를 붙이면 되지만 아래와 같은 방법으로도 사용 가능합니다.

    <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced8.swift %} </p>
...
- **재귀적 / 간접 타입 열거형 선언**
    ...
    - 전체에 적용
        ...
        <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced9.swift %} </p>

    - 특정 항목에만 적용

        <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced10.swift %} </p>

- **재귀적 / 간접 타입 열거형 사용**

    <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced11.swift %} </p>
...
- **비교 연산자 만들기**
    ...
    비교 연산자를 만드는건 구조체나 다른 곳에서 만드는 방식과 동일하게 **func ==() -> Bool**을 사용하면 됩니다.

    비교 연산자 메서드 안에서 switch 문을 이용해 연관 값을 추출한 후 where을 통해 비교하고자 하는 값을 비교하여 결과를 리턴 해주면 됩니다.

    <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced12.swift %} </p>

- **비교 연산자 사용하기**

    위에 비교 연산자를 만들었다면 사용하는 방법은 일반적인 비교 연산자와 동일합니다.

    <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced13.swift %} </p>
...
- **커스텀 생성자 만들기**
    ...
    생성자 만드는 방법은 구조체나 클래스의 생성자를 만드는 방법과 동일하게 **init**을 만들어 주면 됩니다. 아래는 서버에서 받은 에러 코드 값으로 에러 메시지를 찾는 열거형입니다.

    <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced14.swift %} </p>

- **커스텀 생성자 사용하기**

    <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced15.swift %} </p>

- **실패할 수 있는 생성자 만들기**

    열거형에도 실패할 수 있는 생성자를 만들 수 있습니다. init 뒤에 ?만 붙여 주면 원하는 초기화 값이 없을 경우 nil을 반환하게 됩니다.

    <p> {% gist swieeft/aa0bfe9a44771fc747519ada8aa06694 EnumAdvanced16.swift %} </p>
