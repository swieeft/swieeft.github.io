...
use_math: false
---
안녕하세요. 오늘은 defer 구문을 알아보려고 합니다. defer는 제가 면접을 보러 다니면서 자주 접했던 Swift 문법 질문으로, 내용은 쉽지만 우리가 놓치고 넘어가기 쉬운 문법 중 하나 입니다. 실제로 실무를 하면서도 거의 쓰지 않는 문법이긴 하지만 그래도 필요할 때 적절히 사용하면 좋은 문법입니다.
